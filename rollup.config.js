...
libConfig.targets = [
  { dest: 'dist/mdbreact.cjs.js', format: 'cjs' },
  { dest: 'dist/mdbreact.es.js', format: 'es' },
];
...
umdFullConfig.targets = [
  { dest: 'dist/mdbreact.js', format: 'umd' },
];
...
umdFullConfigMin.targets = [
  { dest: 'dist/mdbreact.min.js', format: 'umd' },
];
