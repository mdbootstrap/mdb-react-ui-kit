...
import  {Carousel, CarouselCaption, CarouselInner, CarouselItem, View, Mask, Container, Fa, Row } from 'mdbreact';
    ...
    return(
      <Container>
        <Row className="align-items-center mt-5">
            ...
            <a className="border grey-text px-2 border-light rounded ml-2" target="_blank"  href="https://mdbootstrap.com/react/advanced/carousel/"><Fa icon="graduation-cap" className="mr-2"/>Docs</a>
        </Row>
        <hr className="mb-5" />
